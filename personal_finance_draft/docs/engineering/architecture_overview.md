...
Sovereign is organized as a trading platform, not a personal-finance app. The current repository now has active implementations across the key data, feature, backtest, execution, and monitoring seams, while still preserving a few legacy compatibility files and reference docs for the older layout.
