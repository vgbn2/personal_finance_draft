...
const BACKEND_CANDIDATES = [
  ...
  path.join(REPO_ROOT, 'build', 'backend', 'core', process.platform === 'win32' ? 'sovereign_wealth.exe' : 'sovereign_wealth'),
...
const HELP_TOPICS = {
  ...
  indicators: [
    ...
    '',
    'Single run',
    '  node backend/cli/sovereign_cli.js bt --sample --rsi 7 --atr 7 --bollinger 10 --volatility 10',
    '',
    'Grid search',
  ...
  examples: [
    ...
    '  node backend/cli/sovereign_cli.js optimize --sample --sample-size 1000 --train-ratio 0.7',
    '',
    'Try a specific indicator configuration',
    '  node backend/cli/sovereign_cli.js bt --sample --rsi 7 --atr 7 --bollinger 10 --volatility 10',
    '  node backend/cli/sovereign_cli.js bt --sample --sample-size 1000 --train-ratio 0.7',
    '',
...
function buildTradeGatewayLaunch(args = []) {
  ...
  const tsxCandidates = [
    ...
    path.join(REPO_ROOT, 'Frontend', 'dashboard', 'node_modules', '.bin', process.platform === 'win32' ? 'tsx.cmd' : 'tsx'),
  ];
