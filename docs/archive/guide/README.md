...
> **Diátaxis Type**: Tutorial (Draft Book Scaffold) | **Status**: Historical Archive | **Preserved for Architectural Continuity**

*Note: This tutorial scaffold records a from-scratch build guide outline preserved in archive for instructional continuity.*
