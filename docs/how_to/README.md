# Sovereign How-To Guides (Problem-Solving Quadrant)

Task-oriented runbooks, deployment guides, operational procedures, and disaster recovery.

---

## Operational Runbooks

| Topic | Guide | Primary Focus |
|---|---|---|
| **Development Setup** | [Environment Setup](environment_setup.md) | Node v20, CMake, C++20 toolchain setup |
...
| **Disaster Recovery** | [Disaster Recovery & Rollback](disaster_recovery_and_rollback.md) | Emergency kill-switches, fail-closed recovery |
| **Testing & CI** | [Testing Surface & Verification](testing_surface_and_verification.md) | Running unit, contract, CTest, and secret tests |
| **Contributing** | [Contributing & PR Hygiene](contributing_and_pr_hygiene.md) | Git workflow, hygiene checks, documentation drift |
