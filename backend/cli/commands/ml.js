...
async function commandMl(args) {
  ...
  console.log('Usage: sovereign ml dump [--symbols A,B] [--timeframe 1d] [--horizon 5] [--corr-period 20] [--days 1095] [--out path] [--no-fred] [--json]');
  return sub ? 1 : 0;
}

module.exports = { commandMl, commandFeaturesDump };
