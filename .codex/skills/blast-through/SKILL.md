---
name: blast-through
description: Low-coding, high-token session mode for reviewing code, optimizing hotspots, security auditing, and checking repo health. Use to find connectivity problems, surface gaps, or run a broad structural pass.
---
