...
// END MOCKS
import { ensureCorrectFileContent, unescapeStringForGeminiBug, resetEditCorrectorCaches_TEST_ONLY, } from './editCorrector.js';
describe('editCorrector', () => {
    ...
    describe('ensureCorrectFileContent', () => {
        ...
        it('should return content unchanged if no escaping issues detected', async () => {
            ...
            const result = await ensureCorrectFileContent(content, mockBaseLlmClientInstance, abortSignal, false);
        ...
        it('should return unescaped content when LLM is disabled and aggressiveUnescape is true', async () => {
            ...
            const result = await ensureCorrectFileContent(content, mockBaseLlmClientInstance, abortSignal, true, // disableLLMCorrection
            true);
