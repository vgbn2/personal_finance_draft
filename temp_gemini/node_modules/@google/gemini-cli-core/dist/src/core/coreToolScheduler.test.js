...
import { DEFAULT_TRUNCATE_TOOL_OUTPUT_THRESHOLD, BaseDeclarativeTool, BaseToolInvocation, ToolConfirmationOutcome, Kind, ApprovalMode, HookSystem, PolicyDecision, ToolErrorType, DiscoveredMCPTool, GeminiCliOperation, } from '../index.js';
...
describe('CoreToolScheduler Sequential Execution', () => {
    ...
    it('should pass serverName and toolAnnotations to policy engine for DiscoveredMCPTool', async () => {
        ...
        const mcpTool = new DiscoveredMCPTool(mockMcpTool, serverName, toolName, 'description', { type: 'object', properties: {} }, createMockMessageBus(), undefined, // trust
        true, // isReadOnly
        ...
        await scheduler.schedule(request, abortController.signal);
        expect(mockPolicyEngineCheck).toHaveBeenCalledWith(expect.objectContaining({ name: toolName }), serverName, annotations);
    });
