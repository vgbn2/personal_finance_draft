 ...
 */
import { PREVIEW_GEMINI_MODEL, PREVIEW_GEMINI_3_1_MODEL, } from '../config/models.js';
 ...
 */
export function isOverageEligibleModel(model) {
 ...
 */
export function wrapInAccountChooser(email, continueUrl) {
 ...
 */
export function buildG1Url(path, email, campaign) {
 ...
 */
export function getG1CreditBalance(tier) {
 ...
 */
export function shouldAutoUseCredits(strategy, creditBalance) {
 ...
 */
export function shouldShowOverageMenu(strategy, creditBalance) {
    return (strategy === 'ask' &&
        creditBalance != null &&
        creditBalance >= MIN_CREDIT_BALANCE);
}
 ...
 */
export function shouldShowEmptyWalletMenu(strategy, creditBalance) {
