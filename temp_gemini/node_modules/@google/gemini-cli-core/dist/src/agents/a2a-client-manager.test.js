...
import { ClientFactory, DefaultAgentCardResolver, createAuthenticatingFetchWithRetry, ClientFactoryOptions, } from '@a2a-js/sdk/client';
...
describe('A2AClientManager', () => {
    ...
    describe('sendMessageStream', () => {
        ...
        it('should send a message and return a stream', async () => {
            ...
            sendMessageStreamMock.mockReturnValue((async function* () {
                yield mockResult;
            })());
        ...
        it('should throw prefixed error on failure', async () => {
            ...
            }).rejects.toThrow('[A2AClientManager] sendMessageStream Error [TestAgent]: Network error');
        });
