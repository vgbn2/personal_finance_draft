...
describe('CloudPaidPrivacyNotice', () => {
    ...
    it('renders correctly', async () => {
        const { lastFrame, waitUntilReady, unmount } = render(_jsx(CloudPaidPrivacyNotice, { onExit: onExit }));
    ...
    it('exits on Escape', async () => {
        const { waitUntilReady, unmount } = render(_jsx(CloudPaidPrivacyNotice, { onExit: onExit }));
        await waitUntilReady();
