...
describe('<AppHeader />', () => {
    it('should render the banner with default text', async () => {
        ...
        const { lastFrame, waitUntilReady, unmount } = renderWithProviders(_jsx(AppHeader, { version: "1.0.0" }), {
            config: mockConfig,
            uiState,
        });
    ...
    it('should increment the version count when default banner is displayed', async () => {
        ...
        const { waitUntilReady, unmount } = renderWithProviders(_jsx(AppHeader, { version: "1.0.0" }), {
            config: mockConfig,
            uiState,
        });
        await waitUntilReady();
    ...
    it('should show tips until they have been shown 10 times (persistence flow)', async () => {
        ...
        // First session
        const session1 = renderWithProviders(_jsx(AppHeader, { version: "1.0.0" }), {
            config: mockConfig,
            uiState,
        });
        ...
        const session2 = renderWithProviders(_jsx(AppHeader, { version: "1.0.0" }), {
            config: mockConfig,
        });
