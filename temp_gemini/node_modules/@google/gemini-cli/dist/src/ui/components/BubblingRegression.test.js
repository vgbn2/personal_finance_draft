...
describe('Key Bubbling Regression', () => {
    ...
    it('does not navigate when pressing "j" or "k" in a focused text input', async () => {
        const { stdin, lastFrame } = renderWithProviders(_jsx(AskUserDialog, { questions: choiceQuestion, onSubmit: vi.fn(), onCancel: vi.fn(), width: 120, availableHeight: 20 }), { width: 120 });
...
//# sourceMappingURL=BubblingRegression.test.js.map