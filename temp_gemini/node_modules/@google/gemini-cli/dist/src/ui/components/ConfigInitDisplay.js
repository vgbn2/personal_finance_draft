...
import { CoreEvent, coreEvents, MCPServerStatus, } from '@google/gemini-cli-core';
import { GeminiSpinner } from './GeminiSpinner.js';
import { theme } from '../semantic-colors.js';
export const ConfigInitDisplay = ({ message: initialMessage = 'Initializing...', }) => {
    ...
    useEffect(() => {
        const onChange = (clients) => {
            ...
            if (connecting.length > 0) {
                ...
                setMessage(initialMessage && initialMessage !== 'Initializing...'
