...
describe('ConsentPrompt', () => {
    ...
    it('renders a string prompt with MarkdownDisplay', async () => {
        ...
        const { waitUntilReady, unmount } = render(_jsx(ConsentPrompt, { prompt: prompt, onConfirm: onConfirm, terminalWidth: terminalWidth }));
    ...
    it('renders a ReactNode prompt directly', async () => {
        const prompt = _jsx(Text, { children: "Are you sure?" });
        const { lastFrame, waitUntilReady, unmount } = render(_jsx(ConsentPrompt, { prompt: prompt, onConfirm: onConfirm, terminalWidth: terminalWidth }));
        await waitUntilReady();
    ...
    it('passes correct items to RadioButtonSelect', async () => {
        ...
        const { waitUntilReady, unmount } = render(_jsx(ConsentPrompt, { prompt: prompt, onConfirm: onConfirm, terminalWidth: terminalWidth }));
        await waitUntilReady();
        expect(MockedRadioButtonSelect).toHaveBeenCalledWith(expect.objectContaining({
            items: [
...
//# sourceMappingURL=ConsentPrompt.test.js.map