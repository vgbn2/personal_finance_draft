...
describe('colorizeCode', () => {
    it('renders empty lines correctly when useAlternateBuffer is true', async () => {
        ...
        }, { path: '', settings: {}, originalSettings: {} }, true, []);
        ...
        const { lastFrame, waitUntilReady, unmount } = renderWithProviders(_jsx(_Fragment, { children: result }));
...
//# sourceMappingURL=CodeColorizer.test.js.map