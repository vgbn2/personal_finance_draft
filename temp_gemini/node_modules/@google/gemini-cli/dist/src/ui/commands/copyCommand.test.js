...
describe('copyCommand', () => {
    ...
    it('should copy last AI message to clipboard successfully', async () => {
        ...
        expect(mockCopyToClipboard).toHaveBeenCalledWith('Hi there! How can I help you?', expect.anything());
    });
    it('should handle multiple text parts in AI message', async () => {
        ...
        mockCopyToClipboard.mockResolvedValue(undefined);
        const result = await copyCommand.action(mockContext, '');
        expect(mockCopyToClipboard).toHaveBeenCalledWith('Part 1: Part 2: Part 3', expect.anything());
        expect(result).toEqual({
            type: 'message',
            messageType: 'info',
            content: 'Last output copied to the clipboard',
    ...
    it('should filter out non-text parts', async () => {
        ...
        mockCopyToClipboard.mockResolvedValue(undefined);
        const result = await copyCommand.action(mockContext, '');
        expect(mockCopyToClipboard).toHaveBeenCalledWith('Text part more text', expect.anything());
        expect(result).toEqual({
            type: 'message',
            messageType: 'info',
            content: 'Last output copied to the clipboard',
    ...
    it('should get the last AI message when multiple AI messages exist', async () => {
        ...
        mockCopyToClipboard.mockResolvedValue(undefined);
        const result = await copyCommand.action(mockContext, '');
        expect(mockCopyToClipboard).toHaveBeenCalledWith('Second AI response', expect.anything());
        expect(result).toEqual({
            type: 'message',
            messageType: 'info',
            content: 'Last output copied to the clipboard',
...
//# sourceMappingURL=copyCommand.test.js.map