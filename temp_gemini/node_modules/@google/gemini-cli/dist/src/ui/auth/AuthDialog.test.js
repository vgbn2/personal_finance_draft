...
describe('AuthDialog', () => {
    ...
    beforeEach(() => {
        ...
        vi.stubEnv('GEMINI_CLI_USE_COMPUTE_ADC', undefined);
        vi.stubEnv('GEMINI_DEFAULT_AUTH_TYPE', undefined);
    ...
    describe('Environment Variable Effects on Auth Options', () => {
        ...
        ])('correctly shows/hides COMPUTE_ADC options $desc', async ({ env, shouldContain, shouldNotContain }) => {
            for (const [key, value] of Object.entries(env)) {
                vi.stubEnv(key, value);
            }
            const { waitUntilReady, unmount } = renderWithProviders(_jsx(AuthDialog, { ...props }));
    ...
    it('displays authError when provided', async () => {
        ...
        const { lastFrame, waitUntilReady, unmount } = renderWithProviders(_jsx(AuthDialog, { ...props }));
        await waitUntilReady();
