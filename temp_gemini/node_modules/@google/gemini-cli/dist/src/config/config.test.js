...
import { DEFAULT_FILE_FILTERING_OPTIONS, OutputFormat, SHELL_TOOL_NAME, WRITE_FILE_TOOL_NAME, EDIT_TOOL_NAME, WEB_FETCH_TOOL_NAME, ASK_USER_TOOL_NAME, debugLogger, ApprovalMode, } from '@google/gemini-cli-core';
...
vi.mock('@google/gemini-cli-core', async () => {
    ...
    return {
        ...
        getAdminErrorMessage: vi.fn((_feature) => `YOLO mode is disabled by your administrator. To enable it, please request an update to the settings at: https://goo.gle/manage-gemini-cli`),
...
describe('loadCliConfig', () => {
    ...
    it('should use default fileFilter options when unconfigured', async () => {
        ...
        expect(config.getCustomIgnoreFilePaths()).toEqual(DEFAULT_FILE_FILTERING_OPTIONS.customIgnoreFilePaths);
...
describe('mergeExcludeTools', () => {
    ...
    it('should return default excludes when no excludeTools are specified and it is not interactive', async () => {
        ...
        const argv = await parseArguments(createTestMergedSettings());
        const config = await loadCliConfig(settings, 'test-session', argv);
        expect(config.getExcludeTools()).toEqual(new Set([...defaultExcludes, ASK_USER_TOOL_NAME]));
    });
...
describe('Approval mode tool exclusion logic', () => {
    ...
    it('should throw an error if YOLO mode is attempted when disableYoloMode is true', async () => {
        ...
        await expect(loadCliConfig(settings, 'test-session', argv)).rejects.toThrow('YOLO mode is disabled by your administrator. To enable it, please request an update to the settings at: https://goo.gle/manage-gemini-cli');
    });
...
describe('loadCliConfig with admin.mcp.config', () => {
    ...
    it('should merge local fields and prefer admin tool filters', async () => {
        ...
        const localMcpServersWithTools = {
            serverA: {
                ...localMcpServers['serverA'],
