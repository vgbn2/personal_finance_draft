...
import { Storage, shutdownTelemetry, isTelemetrySdkInitialized, ExitCodes, } from '@google/gemini-cli-core';
 ...
 */
export function registerTelemetryConfig(config) {
