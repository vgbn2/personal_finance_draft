...
| Closed for source | committed-source proof | The combined session-100/101 implementation is committed at `e0de66de`. | Run clean archive/fresh-clone gates before deployment claims; host runtime proof remains separate. |
