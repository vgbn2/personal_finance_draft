...
| `backend/cli` | working tree | 2026-07-13 | C / duplication-gated | viewport/navigation + duplicate-owner + automation safety repair | Live automation rejects unverified data, and Polymarket bot cycles require the correct feature and authorization boundaries. The 51-vs-49 manifest split remains. |
